...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("JebatCoin Core jebatcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  jebatcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jebatcoin transaction") + "\n" +
                               "  jebatcoin-tx [options] -create [commands]   " + _("Create hex-encoded jebatcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded jebatcoin transaction
