...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop JebatCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "JebatCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* JebatCoin features */
        {"jebatcoin", "masternode", &masternode, true, true, false},
        {"jebatcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"jebatcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"jebatcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"jebatcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"jebatcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"jebatcoin", "startmasternode", &startmasternode, true, true, false},
        {"jebatcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"jebatcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"jebatcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"jebatcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"jebatcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"jebatcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"jebatcoin", "mnbudget", &mnbudget, true, true, false},
        {"jebatcoin", "preparebudget", &preparebudget, true, true, false},
        {"jebatcoin", "submitbudget", &submitbudget, true, true, false},
        {"jebatcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"jebatcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"jebatcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"jebatcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"jebatcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"jebatcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"jebatcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"jebatcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"jebatcoin", "mnsync", &mnsync, true, true, false},
        {"jebatcoin", "spork", &spork, true, true, false},
        {"jebatcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"jebatcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use jebatcoind, or the -server option to jebatcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> jebatcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31752/\n";
}
