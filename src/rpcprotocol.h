...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! JebatCoin is not connected
    ...
    RPC_WALLET_PASSJEBATCOINASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
