                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("JebatCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a JebatCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and jebatcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zJCOIN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About JebatCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about JebatCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for JebatCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your JebatCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified JebatCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a JebatCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the JebatCoin Core help message to get a list with possible JebatCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("JebatCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to JebatCoin network", "", count));
}
...
{
    QString strTitle = tr("JebatCoin Core"); // default title
...
/** Creates context menu, its actions, and jebatcoins up all the relevant signals for mouse events. */
