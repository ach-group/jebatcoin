...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("JebatCoin Core"),
     ...
     * override -datadir in the jebatcoin.conf file in the default data directory
     * (to be consistent with jebatcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
