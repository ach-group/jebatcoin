                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received JebatCoin from zJCOIN"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zJCOIN"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zJCOIN));
