...
public:
    ...
    void setZJebatCoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzJCOIN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzJCOIN_clicked();
    void on_pushButtonZJebatCoinControl_clicked();
