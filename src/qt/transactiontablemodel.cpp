...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted JebatCoin to zJCOIN");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zJCOIN");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received JebatCoin from zJCOIN");
    case TransactionRecord::ZerocoinSpend_Change_zJCOIN:
        return tr("Minted Change as zJCOIN from zJCOIN Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zJCOIN to JebatCoin");
