...
/** Utility functions used by the JebatCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render JebatCoin addresses in monospace font
...
// Parse "jebatcoin:" URI into recipient object, return true on successful parsing
