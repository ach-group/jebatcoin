Contributing to JebatCoin Core
============================

The JebatCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the JebatCoin Core project, and is not to be
confused with overall JebatCoin Network Protocol consensus changes.

Whether a pull request is merged into JebatCoin Core rests with the project merge
...
Patches that change JebatCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the JebatCoin consensus, it must have been
...
The project leader is the release manager for each JebatCoin Core release.
