...
In order to support loading of multiple wallets in jebatcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is jebatcoin.cpp.
...
Changes to jebatcoin.cpp
----------------------
jebatcoin.cpp is the entry point into jebatcoin-qt, and as such, will require some minor modifications to provide hooks for
