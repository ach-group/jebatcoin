...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/jebatcoin-cli.cpp \
           src/jebatcoin-tx.cpp \
           src/jebatcoin.cpp \
           src/db.cpp \
           ...
           src/qt/jebatcoin.cpp \
           src/qt/jebatcoinstrings.cpp \
...
RESOURCES += src/qt/jebatcoin.qrc src/qt/jebatcoin_locale.qrc

TRANSLATIONS += src/qt/locale/jebatcoin_bg.ts \
                src/qt/locale/jebatcoin_de.ts \
                src/qt/locale/jebatcoin_en.ts \
                src/qt/locale/jebatcoin_es.ts \
                src/qt/locale/jebatcoin_fi.ts \
                src/qt/locale/jebatcoin_fr.ts \
                src/qt/locale/jebatcoin_it.ts \
                src/qt/locale/jebatcoin_ja.ts \
                src/qt/locale/jebatcoin_pl.ts \
                src/qt/locale/jebatcoin_pt.ts \
                src/qt/locale/jebatcoin_ru.ts \
                src/qt/locale/jebatcoin_sk.ts \
                src/qt/locale/jebatcoin_sv.ts \
                src/qt/locale/jebatcoin_vi.ts \
                src/qt/locale/jebatcoin_zh_CN.ts \
                src/qt/locale/jebatcoin_zh_TW.ts
